...
{
    public abstract class Block : IGameObject, IMovable, ITouchable, IToolSupport
    {
        ...
        public Block(GameScreen Screen, TeamColor TeamColor)
        {
            this.Screen = Screen;
        ...
        public virtual void Move(Vector2D vector)
        {
            ...
            if (!Active)
            {
                ...
                else
                {
                    ...
                    {
                        PScreen.MovableShapes.Remove(this);
                        return;
                    }
                }
            }
