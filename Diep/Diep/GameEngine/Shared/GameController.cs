...
namespace Diep.GameEngine.Shared
{
    public abstract class GameController : IGameObject
    {
        ...
        public GameController(Control Control, MessageFilter MessageFilter, Boolean EnableStepping, Boolean EnableDrawing)
        {
        ...
        public bool EnableStepping { get; }
        public bool EnableDrawing { get; }
